...
class MujocoEnv(gym.Env):
    ...
    def render(self, mode="human"):
        if mode == "human":
            ...
            # Check if the "track" camera exists, otherwise use the default camera
            camera_name = "track" if "track" in self.model.camera_names else None
            return self.sim.render(width=640, height=480, camera_name=camera_name)
        else:
